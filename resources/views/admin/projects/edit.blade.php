        ...
        <div class="col-md-12">
            <div class="about-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-md-6">
                            <h4 class="m-0 text-uppercase">Project | Edit</h4>
                        </div>
                        <div class="col-md-6">
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="p-0 m-0">Edit project</h5>
                </div>
                <div class="card-body">
                    <form method="POST" action="{{ url('/admin/project/update/'.$project->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="desc_ar" value="{{ $project->desc_ar }}" rows="5">{{ $project->desc_ar }}</textarea>
                        </div>
                        <div class="form-group">
                            <label>Description (EN)</label>
                            <textarea class="form-control ckeditor" name="desc_en" value="{{ $project->desc_en }}" rows="5">{{ $project->desc_en }}</textarea>
                        </div>
                        <div class="form-group">
                            <label>Image</label>
