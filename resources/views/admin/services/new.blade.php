        ...
        <div class="col-md-12">
            <div class="about-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-md-6">
                            <h4 class="m-0 text-uppercase">Services | Add</h4>
                        </div>
                        <div class="col-md-6">
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="p-0 m-0">Add new service</h5>
                </div>
                <div class="card-body">
                    <form method="POST" action="{{ url('/admin/service/save') }}" enctype="multipart/form-data">
                        @csrf
