        ...
        <div class="col-md-12">
            <div class="services-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-md-6">
                            <h2 class="m-0 text-uppercase">Blog Images</h2>
                        </div>
                        <div class="col-md-6">
            ...
            <div class="card">
                <div class="card-header">
                    <div class="row align align-items-center">
                        <div class="col-md-6">
                            <h3 class="card-title p-0 m-0">Blog Images</h3>
                        </div>
                        <div class="col-md-6 text-right">
                            <a class="btn btn-info btn-sm btn-flat" href="{{ url('admin/blog/addImg/'.Request::route('id')) }}">
                                    ...
                                    <tbody>
                                        @foreach ($images as $img)
                                            <tr>
                                                <td>{{ $img->id }}</td>
                                                <td>
                                                    <img src="{{ asset('assets/upload/blogs_images/'.$img->image) }}" class="admin-service-img" alt="Service image">
                                                </td>
                                                <td>
                                                    <a class="btn btn-warning btn-sm btn-flat" href="{{ url('admin/blog/editImg/'.$img->id) }}">
